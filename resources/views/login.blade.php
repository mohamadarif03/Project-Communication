            ...
            <form method="POST" class="register-form" id="register-form">
              ...
              <div class="">
                ...
                <div class="form-group">
                  ...
                  <input type="password" style="border: none; padding: 15px; " name="pass" id="pass" placeholder="     Password" />
                </div>
              </div>
              <div class="form-group form-button">
                <input type="submit" name="signup" id="signup" class="form-submit" value="Register" style="width: 100%; background: #FFD93D;
