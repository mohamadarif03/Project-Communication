      ...
      <div class="">
        <div class="signup-content">
            ...
            <form action="" method="POST" class="register-form" id="register-form">
              ...
              <div class="">
                ...
                <div class="form-group">
                  ...
                  <input type="password" style="border: none; padding: 15px; " name="password" id="pass" placeholder="Password" />
                </div>
              </div>
              <div class="form-group form-button">
                <input type="submit" name="signup" id="signup" class="form-submit" value="Login" style="width: 100%; background: #FFD93D;
          ...
          <div class="signup-image">
            <figure>
              <img src="{{asset('login/images/20230412_165257.png')}}" width="60%" alt="sing up image">
            </figure>
