    ...
    <div class="content">
        <div class="container-fluid flex flex-col md:flex-row justify-evenly md:justify-between mt-3">
            ...
            <div class="grid grid-cols-2 gap-2">
                ...
                <button type="button" onclick="GetData()" class="col-span-1 focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-yellow-300 font-medium rounded-lg text-xs px-5 py-2.5 mr-2 mb-2 flex items-center">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <div class="">
                                    ...
                                    <Select multiple id="from" name="To2" class="" placeholder="Role">
                                        <option value=""></option>
                                    </Select>
                                </div>
                                <div class="mt-1.5">
                        ...
                        <div class="grid grid-col-1 md:grid-cols-2">
                            ...
                            <div>
                                <div class=""  id="update-from-form">
                                    ...
                                    <label for="from class=" mb-2 text-sm font-medium text-gray-900 ">From</label>
                                    <Select multiple id="update-from" name="To2" class="" placeholder="Role">
                                        <option value=""></option>
                                    </Select>
                                </div>
