    ...
    <div class="content">
        ...
        <div class="container-fluid flex justify-between">
            ...
            <div class="flex">
                ...
                <Select id="forsearch" name="forsearch" value="{{ Request::get('forsearch') }}" class="mr-4" placeholder="Choose Type">
                    <option value=""></option>
                            ...
                            <table class="min-w-full text-left text-sm font-light">
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b border-dashed dark:border-neutral-500">
                                        ...
                                        <td class="whitespace-nowrap px-6 py-4">
                                            <div class="rounded-circle w-8 h-8" style=" background-color:{{$row->color}}"></div>
                                        </td>
                                        <td class="whitespace-nowrap px-6 py-4 flex"
                                            ...
                                            <button class="btn-delete" data-id="{{$row->id}}" data-name="{{$row->name}}">
