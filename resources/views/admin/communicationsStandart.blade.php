        ...
        <div class="container-fluid flex flex-col md:flex-row justify-evenly md:justify-between mt-3">
            ...
            <div class="">
                ...
                <div class="flex grid grid-cols-2">
                      <input type="text" id="search" placeholder="Name" name="search" class="focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 flex">
        ...
        <div data-te-modal-dialog-ref
            ...
            <div
                ...
                <div class="relative p-4">
                    ...
                    <div class="flex gap-4 items-center mt-2" id="to-form">
                        <label for="to" class="mb-2 text-xs font-medium text-gray-900 ml-6">To</label>
                        <Select multiple id="to" name="to" class="w-full ml-4" value="2" placeholder="User">
            ...
            <div
                ...
                <div
                    ...
                    <button type="button" id="btn-close-delete"
                        class="btn-close-delete-hover inline-block rounded px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-red-500 transition duration-150 ease-in-out hover:bg-yellow-accent-100 focus:bg-yellow-accent-100 focus:outline-none focus:ring-0 active:bg-yellow-accent-200"
                        data-te-modal-dismiss data-te-ripple-init data-te-ripple-color="light">
                        Close
                    </button>
