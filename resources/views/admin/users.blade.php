      ...
      <div class="pointer-events-auto relative flex mx-auto flex-col rounded-md border-none bg-white bg-clip-padding text-current shadow-lg outline-none " style="width: 60%">
        ...
        <div class="relative p-4">
            <div>
                ...
                <div class="mb-1.5 flex items-center gap-3">
                    <label for="password_confirmation" class="w-36 mb-2 block text-sm font-medium text-gray-900 ">Role</label>
                    <Select multiple id="type" name="type" class="w-full" placeholder="Role">
                        <option value=""></option>
    ...
    <div data-te-modal-dialog-ref class="pointer-events-none relative flex min-h-[calc(100%-1rem)] w-full translate-y-[-50px] items-center opacity-0 transition-all duration-300 ease-in-out min-[576px]:mx-auto min-[576px]:mt-7 min-[576px]:min-h-[calc(100%-3.5rem)]">
      <div class="pointer-events-auto relative flex mx-auto flex-col rounded-md border-none bg-white bg-clip-padding text-current shadow-lg outline-none " style="width: 60%">
        ...
        <div class="relative p-4">
            <div>
                <div class="mb-1.5 flex items-center gap-3">
                    <label for="update-name" class="w-36 mb-2 block text-sm font-medium text-gray-900 ">Name</label>
                    <input type="text" id="update-name" class="bg-gray-50 border border-gray-500 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" style="border-radius: 3px" placeholder="Name" required>
                </div>
                <div class="mb-1.5 flex items-center gap-3">
                    <label for="update-email" class="w-36 mb-2 block text-sm font-medium text-gray-900 ">Email</label>
                    <input type="email" id="update-email" class="bg-gray-50 border border-gray-500 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" style="border-radius: 3px" placeholder="Email" required>
                </div>
                <div class="mb-1.5 flex items-center gap-3">
                    <label for="update-password" class="w-36 mb-2 block text-sm font-medium text-gray-900 ">Password</label>
                    <input type="password" id="update-password" class="bg-gray-50 border border-gray-500 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" style="border-radius: 3px" placeholder="Password" required>
                </div>
                <div class="mb-1.5 flex items-center gap-3">
                    <label for="update-password_confirmation" class="w-36 mb-2 block text-sm font-medium text-gray-900 ">Password Confirmation</label>
                    <input type="password" id="update-password_confirmation" class="bg-gray-50 border border-gray-500 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" style="border-radius: 3px" placeholder="Password Confirmation" required>
                </div>
            </div>    
        </div>
