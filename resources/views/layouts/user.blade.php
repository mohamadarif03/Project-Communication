                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li class="@yield('Responsbility.li')">
                                <a class="@yield('Responsbility.a')">
                                    <svg class="" fill="@yield('Responsbility.svg','#6e768e')" xmlns="http://www.w3.org/2000/svg" height="24" width="48" fill="currentColor" class="bi bi-person-badge" viewBox="0 0 16 16">
