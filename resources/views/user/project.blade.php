            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 mx-3 mt-4" id="Data">
                <div class="col-span-1 w-full h-36 px-2 py-1 mt-1 rounded-md bg-white">
                    <div class="h-8 p-2 items-center w-full relative flex">
                        <button onclick="showdropdown()" class="ml-auto h-5 w-5 rounded-circle bg-transparent">
                        ...
                        <ul id="dropdownlist-detail" class="absolute dropdown-edit hidden z-[1000] float-left right-9 top-3 border-2 m-0 min-w-max list-none overflow-hidden rounded-lg p-1 border-none bg-white bg-clip-padding text-left text-base shadow-lg" >
                            <li>
