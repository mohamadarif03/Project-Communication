...
@section('content')
    ...
    <div class="content">
        ...
        <div class="w-full flex flex-col">
            <div class="" style="display: grid; grid-template-columns: repeat(4, 1fr); grid-gap: 10px;"> 
                <div class="col-span-3 grid grid-cols-3 gap-2" id="Data">
                ...
                <div id="baris" style="grid-row: span 2;" class="mt-1 col-span-1 rounded-md bg-white"> 
                        ...
                        <div class="ml-2 flex my-auto">
                            <div class="ml-2 my-auto" >   
                                 ...
                                 @elseif($data->size == 'Medium')                         
                                  ...
                                  <div class="my-6 flex justify-between my-checkbox">
                                    <label class="my-0 font-bold" style="font-size:17px;margin-right:9px">Human Design</label>
                                    <input type="checkbox" value="humanDesign" name="my-checkbox" id="">
                                  </div>
                                  <div class="my-6 flex justify-between my-checkbox">
                                    <label class="my-0 font-bold" style="font-size:17px;margin-right:9px">Brainstrom</label>
                                  ...
                                  <div class="my-6 flex justify-between my-checkbox">
                                    <label class="my-0 font-bold" style="font-size:17px;margin-right:9px">GameTrust</label>
                                    <input type="checkbox" value="gameTrust" name="my-checkbox" id="">
                                  </div>
                                  <div class="my-6 flex justify-between my-checkbox">
                                    <label class="my-0 font-bold" style="font-size:17px;margin-right:9px">WOW Design</label>
                                    <input type="checkbox" value="wowDesign" name="my-checkbox" id="">
                                  </div>
                                  <div class="my-6 flex justify-between my-checkbox">
                                    <label class="my-0 font-bold" style="font-size:17px;margin-right:9px">Levering</label>
                                    <input type="checkbox" value="levering" name="my-checkbox" id="">
                                  </div>
                                  <div class="my-6 flex justify-between my-checkbox">
                                    <label class="my-0 font-bold" style="font-size:17px;margin-right:9px">Afsluiting</label>
