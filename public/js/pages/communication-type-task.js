            ...
            if(response.length > 0){
                $.each(response,function(index,data){
                    var row = '<tr class="border-b border-dashed ">'+
                                ...
                                '<td class="whitespace-nowrap px-6 py-4" style="color: rgb(24, 24, 24); font-weight: 400;">'+data.color+'</td>'+ 
                                '<td class="whitespace-nowrap px-6 py-4 flex" style="color: rgb(24, 24, 24); font-weight: 400;">'+ 
                                '<button onclick="show('+data.id+')" id="btn-edit-'+data.id+'" data-name="'+data.type+'" data-color="'+data.color+'" data-description="'+data.description+'">'+ 
