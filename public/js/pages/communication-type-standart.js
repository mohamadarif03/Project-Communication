...
'</svg>'+
                                '</button>'+ 
                                '<button onclick="edit('+data.id+')" id="btn-edit-'+data.id+'" data-name="'+data.type+'" data-color="'+data.color+'" data-description="'+data.description+'" data-to="'+data.to+'">'+ 
