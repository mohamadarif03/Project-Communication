...
GetDataComplete() 
  ...
  function GetDataUncomplete(){
    ...
    $.ajax({
        type:'GET',
        url:'/data-receive-communication-dashboard-uncomplete',
        success:function(response){
                $.each(response,function(index,data){
                  ...
                  '<div class="h-2 p-2 items-center w-full flex justify-between ">'+
                      ...
                      '</a>'+
                      '<p class="rounded-md text-xs py-0.5 px-2 mt-3" style="background-color: #E0E0E0; color: black;">'+formatDate(data.date)+'</p>'+
                  '</div>'+
